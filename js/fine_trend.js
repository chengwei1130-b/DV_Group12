  ...
  window.appDataPromise
    .then(rawData => {
      ...
      function updateChart(selectedYear) {
        ...
        inner.selectAll(".stem").remove();
        inner.selectAll(".lollipop-head").remove();
        inner.selectAll(".value-label").remove();
        ...
        const yScale = d3.scaleLinear()
          .domain([0, d3.max(aggregated, d => d.SpeedingFines / 1000000)])
          .nice()
          .range([innerHeight, 0]);
        ...
        inner.selectAll(".stem")
          ...
          .attr("y1", innerHeight)
          .attr("y2", d => yScale(d.SpeedingFines / 1000000))
          .attr("stroke", "#F97316")
        ...
        inner.selectAll(".lollipop-head")
          ...
          .attr("cy", d => yScale(d.SpeedingFines / 1000000))
          .attr("r", 9)
          .attr("fill", "#F97316")
          .attr("stroke", "#FFFFFF")
          .attr("stroke-width", 2)
        ...
        inner.selectAll(".value-label")
          ...
          .attr("y", d => yScale(d.SpeedingFines / 1000000) - 16)
          .attr("text-anchor", "middle")
          .attr("font-size", "12px")
          .attr("fill", "#374151")
          .text(d => (d.SpeedingFines / 1000000).toFixed(2) + "M");
      }
